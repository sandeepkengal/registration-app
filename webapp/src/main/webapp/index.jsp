<form action="action_page.php" style="background-color:violet">
  <div class="container">
    ...
    <input type="text" placeholder="Enter Full Name" name="Name" id="Name" style="background-color:black" required>
    <br>
